/*
 * Github: https://github.com/markszabo/Hacktivity2016
 * 
 */
...
uint8_t phone[6] = {0x14,0x1A,0xA3,0xF7,0xCF,0xA1};
/* Moto G3 /\ */
uint8_t pc[6] = {0x30,0x3A,0x64,0x90,0x83,0xCE};
/* HP Envy 17 TS */
...
uint8_t ap[6] = {0x68,0x15,0x90,0x5D,0x92,0x0A};
/* GVT-9209 /\ */


// Client MAC to deauth
uint8_t client[6] = {0x14,0x1A,0xA3,0xF7,0xCF,0xA2};//wrong
/* Moto G3 /\ */
...
void promisc_cb(uint8_t *buf, uint16_t len)
{
    if (len == 12){
        ...
        /*
         * kay: 
         *    i'm trying to comment out this line to see if it's possible to deauth a client without restrictions
         * 
         */
