...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "bWFyaWFuYWNhcmRvc28zMnU0QGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "bWFyaWNhcmQzMjg=";
        const char* FROM = "some_random_email@gmail.com";
